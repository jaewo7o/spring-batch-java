...
@SpringBatchTest
@SpringBootTest(classes = {CsvProcessorJob2.class, BatchTestConfig.class})
class CsvProcessorJob2Test {

    @Autowired
    JobLauncherTestUtils jobLauncherTestUtils;

    @Test
    @DisplayName("CSV PROCESS - FILTER")
    void csvProcessorJob1Build() throws Exception {
        // given
