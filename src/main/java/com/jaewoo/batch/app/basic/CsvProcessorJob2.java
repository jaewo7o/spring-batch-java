...
@Slf4j
@Configuration
public class CsvProcessorJob2 {
    private static final String BATCH_JOB = "csvProcessorJob2Job";
    ...
    public FlatFileItemReader<TwoToken> reader() {
        ...
        itemReader.setResource(new ClassPathResource("sample/csvProcessorJob2_input.csv"));
    ...
    public FlatFileItemWriter<TwoToken> writer() {
        ...
        itemWriter.setResource(new FileSystemResource("output/csvProcessorJob2_output.csv"));
